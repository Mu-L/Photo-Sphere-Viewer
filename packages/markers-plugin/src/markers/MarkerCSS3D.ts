...
export class MarkerCSS3D extends AbstractDomMarker {
    ...
    override createElement(): void {
        ...
        object.userData = { [MARKER_DATA]: this };
    ...
    override render({
        ...
        // FIXME reliable visibility detection
        // this.viewer.renderer.isObjectVisible(this.state.positions3D[0])
        const isVisible = this.state.positions3D[0].dot(this.viewer.state.direction) > 0;
